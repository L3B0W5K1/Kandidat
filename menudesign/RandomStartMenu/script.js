document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('random-start-form').addEventListener('submit', function(event) {
      ...
      console.log(`Map: ${selectedMap}, Difficulty: ${selectedDifficulty}, Number of Controls: ${numberOfControls}`);
